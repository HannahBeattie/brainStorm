		...
		>
			<VStack py={8} spacing={'8'}>
				...
				>
					<VStack spacing={4}>
						<Text>
							I have recently, gingerly, dipped my toes into the realm of digital and
							generative art thanks to the p5.js library.
						</Text>
						<Text>
						...
						<Text>
							...
							pattern-making abilities; Perhaps trying to mimic my analog, pen-and-ink
							styles in a generative context.
						</Text>
					</VStack>
				</Container>
			</VStack>
