			...
			<FadeIn>
				...
				>
					...
					<Appear style={{ width: '100%' }}>
						...
						>
							<Text>
								Studio Monkey is a premier VFX management tool used my many high
								profile studios. I worked in close dialog with CEO Zach Tucker to
								create a visual brand identity, logo and website aesthetic that fit
								the ethos and intention of the company — functional, minimal,
								playful and highly customer-focused. The website was a collaboration
								between myself and Mikey Lemmon who handled the backend
								functionality and software integration, while I focused on the
					...
					<Appear style={{ width: '100%' }}>
						...
						>
							<Text>
								...
								Contentful, a headless CMS, to demonstrate how these tools may be
								used for something that is a real website.
							</Text>
						</MinimalLayout>
					</Appear>
					<Appear>
