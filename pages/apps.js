					...
					<Container alignSelf={'center'}>
						<VStack spacing={'4'}>
							<Text align={'start'} fontFamily={'Poppins'}>
								Since graduating at Dev Acadamy in April 2022, I have been focused
								on sharpning my skillset and adapting it to new tools, as well as
							...
							<Text align={'start'} fontFamily={'Poppins'}>
								Rather than leaning into gimmic or flashy, overpowering elements,
								that can intrude on the functionality and acceccability of a site, I
								am curious about the ways that minimal, functional language can be
								combined with optional, whimsical interactions.
							</Text>
							<Text align={'start'} fontFamily={'Poppins'}>
							...
							<Text align={'start'} fontFamily={'Poppins'}>
								Increasingly there is a desire for something playful, personal and
								real.
							</Text>
							<Text align={'start'} fontFamily={'Poppins'}>
							...
							<Text align={'start'} fontFamily={'Poppins'}>
								I am excited about creating things that feel meaningful, exciting
								and
							</Text>
						</VStack>
					</Container>
