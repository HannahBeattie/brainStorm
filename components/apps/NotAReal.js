			...
			<GridItem>
				<SmallFocus yIs={10} yIsNow={10}>
					...
					>
						<Image
							h={'300'}
							alt={'The mobile landing page of the not-a-real-website next app'}
							boxShadow={'dark'}
				...
				>
					<VStack spacing={10}>
						<VStack flex={'1'} px={20} spacing={4}>
							...
							<Text>
								After heading about dynamic routes and being thoroughly confused and
								excited about how they worked, I decided I wanted to try them out.
							</Text>
							<Text>
								I had also been curious about headless CMS intergration, so I
								decided to kill to birds with one stone and create an app, with
								which to learn both.
							</Text>
						</VStack>
						<Spacer />
